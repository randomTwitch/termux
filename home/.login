...
alias jobcmd "jobs -l"; set implicitcd=verbose; set listjobs=long; set printexitvalue; set time="1 %k"; set savehist="50"; set histdup="erase"; set histfile="/data/data/com.termux/files/home/.histfile"; set loginsh="true";
